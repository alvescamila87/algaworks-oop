...
public class TestePolitico {
	...
	public static void main(String[] args) {
		...
		vereador.setSalario(new BigDecimal(16_000));
		
		Cargo deputadoEstadual = new Cargo();
		deputadoEstadual.setDescricao("Deputado Estadual");
		deputadoEstadual.setSalario(new BigDecimal(25_000));
		
		Cargo prefeito = new Cargo();
		prefeito.setDescricao("Prefeiro");
		prefeito.setSalario(new BigDecimal(27_000));
		...
		System.out.println("Gastos com deputados estaduais do partido LDRS: " + formatador.format(gastosDeputadosEstaduaisLdrs.doubleValue()));
		
		BigDecimal gastosPrefeitosLdrs = governo.calcularGastosComSalarioParaCargo(prefeito, "LDRS");
		System.out.println("Gastos com prefeitos do partido LDRS: " + formatador.format(gastosPrefeitosLdrs.doubleValue()));
